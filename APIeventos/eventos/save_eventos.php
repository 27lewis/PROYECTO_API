...
$stmt = $mysqli->prepare("INSERT INTO eventos (nombre, descripcion, fechaInicio, fechaFinal, lugar, capacidad, valor) VALUES (?,?,?,?,?,?,?)");
$numparam = "sssssss"; //cantidad de caracteres debe ser igual al numero de parametros
$stmt->bind_param($numparam,$nombre, $descripcion, $fechaInicio, $fechaFinal, $lugar, $capacidad, $valor);
